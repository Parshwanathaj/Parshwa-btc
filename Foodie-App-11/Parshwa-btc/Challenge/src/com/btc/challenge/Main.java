...
public class Main {
	...
	public static void main(String[] args) 
	{
		List<Student> studentList;
			Student s1 = new Student(10011, "Parshwa", 85, 77, 82);
			Student s2 = new Student(10012, "Kavya", 57, 35, 63);
			Student s3 = new Student(10013, "Praju", 32, 71, 61);
			Student s4 = new Student(10014, "Rachu", 55, 52, 61);
			Student s5 = new Student(10015, "Prakyath", 95, 92, 97);

				...
				<div class="row">
					<div class="col">
						<label for="name">Movie Name</label> <input type="text"
							value="${movie.movieName}" id="name" name="movieName"
							readonly="readonly" required>
					</div>
					<div class="col">
						<label for="name">Budget</label> <input type="number"
							value="${movie.movieBudget}" id="name" name="movieBudget"
							required>
					</div>
					...
					<div class="col">
						<label for="designation">Director Name</label> <input type="text"
							value="${movie.directorName}" id="designation"
							name="directorName" required>
					</div>

					<div class="col">
						<label for="department">Hero Name</label> <input type="text"
							id="department" value="${movie.heroName}" name="heroName"
							required>
					</div>
					<div class="col">
						<label for="salary">Language</label> <input type="text"
							value="${movie.language}" id="salary" name="language" required>
					</div>

					<div class="col">
						<label for="id">category</label> <input type="text"
							value="${movie.movieCategory}" id="id" name="movieCategory"
							required>
					</div>
